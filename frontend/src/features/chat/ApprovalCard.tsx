      ...
      <div className="approval-inner p-3">
        ...
        <div className={cn(collapsed && 'hidden')}>
          ...
          <div className="approval-btns mt-3 flex flex-wrap items-center gap-2">
            <button type="button" disabled={busy} onClick={() => { void respond('once') }} className="approval-btn once inline-flex items-center gap-1.5 rounded-md bg-accent px-3 py-1.5 text-sm font-medium text-white" title={m.approval_btn_once_title()}>{m.approval_btn_once()} <kbd className="rounded border border-white/30 px-1 text-[10px]">↵</kbd></button>
