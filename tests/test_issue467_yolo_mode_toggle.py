...
def test_yolo_command_ignores_stale_same_session_generation():
    ...
    owner_start = commands_js.index("function createCommandOwnerContext()")
    owner_helpers = commands_js[
        owner_start:commands_js.index("\nfunction commandSessionChanged()", owner_start)
    ]
