    ...
    try:
        ...
        page.evaluate(
            ...
            () => {
              ...
              window._terminalSessionPath = sid => `/api/session?session_id=${encodeURIComponent(sid)}`;
              window._flushPendingReasoningRender = () => {};
              window._applyTerminalMessageWindowMetadata = () => {};
              window._clearSource = () => {};
              window._closeSource = () => {};
