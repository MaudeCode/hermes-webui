...
class TestSidebarCancelAction:
    def test_running_sidebar_sessions_get_stop_action(self):
        ...
        # manual title regeneration controls, and to 12000 after pin recovery
        # and profile-routing controls were added ahead of Stop.
        ...
        body = _function_body(SESSIONS_JS, "_openSessionActionMenu", 12000)
